...
participant was summed into a new variable called `total_activity` in
the `merged_df_updated` dataset. This was done by grouping `SEQN`,
`sex`, `age`, `BMI`, and `education`.
...
![](p8105_hw3_sjt2164_files/figure-gfm/boxplot-1.png)<!-- -->
...
![](p8105_hw3_sjt2164_files/figure-gfm/boxplot-2.png)<!-- -->

The figures (overview and close-up view) above shows the impact of
